...
/**
 * Computes similarity scores between query vectors and indexed vectors using the JVector format.
 * This class implements the scoring logic used during k-NN search.
 */
